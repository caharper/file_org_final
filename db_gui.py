...
inputs = [
    ...
    [sg.Input(key='input_2', font=('Arial', 18), size=(30,1), pad=((0,0),(0,20)))],
...
output = [
    [sg.Multiline(default_text="", size=(55,12), auto_refresh=True, key='output', do_not_clear=False)]
]
...
window = sg.Window('Bus Network', layout, finalize=True, element_justification='c')
...
def get_driver_info(first_name, last_name):
    ...
    #
    # Response
    driver = "{0} {1}, {2}\n\tAge: {3}\n\tHometown: {4}, {5}\n\t".format("1234", "Lee", "Matthew", 22, "Bedford", "Texas")
    route_assignments = "Routes:\n\t    {0} - {1}".format(523, "Mustang")
    return(driver + route_assignments) 
